// first i want to add up the orders for each business
// then i want to filter out the businesses who spent more than 9000
const businesses = [
    {
  ...
  //this gave me everyone whose total orders is over 9000
// const totalBizOver9k = businesses.filter(business => 
//   (business.orders.reduce((acc, crv) => acc + crv, 0)) >= 9000)

//   console.log(bigSpenders);

  //now i need to cycle through each biz's orders and filter out the biz's which have an order of more than 9k

  //i have to cycle through businesses and look through the orders array
...
//   })
  ...
  console.log(businesses.filter(business => business.orders.find(order => order > 9000) >9000))
